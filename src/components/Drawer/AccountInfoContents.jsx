...
import { userSignOut } from "@/utils/userAuth";
import { useOverlay } from "@/context/OverlayContext";
import UserProfile from "./UserProfile";
import SmoothButtonRedOutline from "../SmoothButton/SmoothButtonRedOutline";
  ...
  useEffect(() => {
    const fetchSession = async () => {
      ...
      if (session?.access_token) {
        const fullName = session.user.user_metadata.full_name || ""; // Fallback to empty string if name is not available
