...
import EditFolderTitle from "./EditFolder/EditFolderTitle";
import DeleteFolderContents from "@/components/Modal/DeleteFolderContents";
import FolderIcon from "../Icons/FolderIcon";

export default function FolderOptionsContents({ folderId, folderName }) {
