...
import MoreOptionsDots from "./MoreOptionsDots";
import { useOverlay } from "@/context/OverlayContext";
import Drawer from "@/components/Drawer/Drawer";
import EditNoteContents from "@/components/Drawer/PostingContents/EditNoteContents";
    ...
    >
      <div className={"relative z-1 " + wrapperVariantStyles[currentVariant]}>
        ...
        <div className={lastSavedVariantStyles[currentVariant]}>
          {disableDateFormatting ? lastSaved : formatDate(lastSaved)}
          {variant === "simple" && (
            <MoreOptionsDots
              noteId={noteId}
              folderId={folderId}
